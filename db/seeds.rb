...
puts "Creating superpower categories..."
  SuperpowerCategory.create!(name: "Perception", icon: "perception.png")
  SuperpowerCategory.create!(name: "Speed", icon: "speed.png")
  SuperpowerCategory.create!(name: "X-ray vision", icon: "xray.png")
  ...
  SuperpowerCategory.create!(name: "Temporal manipulation", icon: "temp_manipulation.png")
